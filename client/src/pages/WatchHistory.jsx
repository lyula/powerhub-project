          ...
          <div className="p-2 md:p-4">
            ...
            <div className="mt-4 md:mt-6">
              <div className="flex flex-col items-center justify-center h-96">
                <h1 className="text-3xl font-bold text-black dark:text-white">Watch History (Placeholder)</h1>
                <p className="mt-2 text-gray-500 dark:text-gray-400">This is a template for the Watch History page.</p>
              </div>
            </div>
          </div>
        </div>
