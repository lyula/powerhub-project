  ...
  return (
    <div className="min-h-screen bg-gray-100 dark:bg-[#111111] w-full" style={{ overflowX: 'hidden', scrollbarWidth: 'none', maxWidth: '100vw' }}>
      ...
      <div className="flex flex-row w-full pt-14" style={{ height: '100vh', maxWidth: '100vw', overflowX: 'hidden', scrollbarWidth: 'none' }}>
        ...
        <div className={`flex-1 flex flex-col ${sidebarOpen ? 'md:ml-64' : 'md:ml-20'} w-full overflow-y-auto`} style={{ maxWidth: '100vw', overflowX: 'hidden', scrollbarWidth: 'none' }}>
          <div className="p-2 md:p-4 pb-8">
            <h2 className="text-lg md:text-xl font-bold mb-2 text-[#0bb6bc] dark:text-[#0bb6bc]">Specializations</h2>
            <div className="mt-4 md:mt-6">
              <div className="flex flex-col items-center justify-center h-96">
                <h1 className="text-3xl font-bold text-black dark:text-white">Specializations (Placeholder)</h1>
                <p className="mt-2 text-gray-500 dark:text-gray-400">This is a template for the Specializations page.</p>
              </div>
            </div>
          </div>
        </div>
